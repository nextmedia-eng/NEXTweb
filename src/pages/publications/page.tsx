  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{
          backgroundImage: `url('https://readdy.ai/api/search-image?query=Academic%20research%20library%20with%20publications%20and%20documents%2C%20professional%20scholarly%20environment%20with%20books%20and%20research%20papers%2C%20modern%20academic%20publishing%20facility&width=1200&height=600&seq=publications-hero&orientation=landscape')`,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          <div className="w-full">
            <div className="text-left text-white max-w-2xl">
              <h1 className="text-5xl font-bold mb-4 leading-tight">발간물</h1>
              <p className="text-xl font-light opacity-90">Publications</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex gap-4 items-center">
              ...
              <button className="bg-blue-600 text-white px-6 py-2 rounded-md text-sm font-medium hover:bg-blue-7 transition-colors whitespace-nowrap">
                검색
              </button>
            </div>
          </div>
